...
T.Slider {
    ...
    handle: Rectangle {
        ...
        //color:control.pressed ? RLSTheme.backgroundColor.C2:RLSTheme.textColor.C12
    ...
    background: Rectangle {
        ...
        implicitWidth: horizontal ? 370 : 4
        implicitHeight: horizontal ? 4 : 370
        width: horizontal ? control.availableWidth : implicitWidth
        height: horizontal ? implicitHeight : control.availableHeight
        radius: 2
        opacity: control.enabled ? 1 : 0.3
        color: RLSTheme.textColor.C12
